...
void ofApp::printFramebufferInfo(GLuint fbo)
{
	// bind fbo
...
bool ofApp::checkFramebufferStatus(GLuint fbo)
{
	// check FBO status
...
std::string ofApp::getTextureParameters(GLuint id)
{
...
std::string ofApp::getRenderbufferParameters(GLuint id)
{
...
std::string ofApp::convertInternalFormatToString(GLenum format)
{
	std::string formatName;
